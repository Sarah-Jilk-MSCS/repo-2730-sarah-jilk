...
' Programmer:   Sarah Jilk on 11/15/2016
...
Public Class Form1
    ...
    Private Sub DisplayColor(ByVal itemNum As String)
        If itemNum.Length <> 7 Then
            MessageBox.Show("Invalid input", "Invalid Item Number Length: " & itemNum, MessageBoxButtons.OK)
        End If

        If itemNum.ToUpper.Substring(3, 1) = "B" Then
            lstColors.Items.Add(itemNum & ": Blue")
        ElseIf itemNum.ToUpper.Substring(3, 1) = "G" Then
            lstColors.Items.Add(itemNum & ": Green")
        ElseIf itemNum.ToUpper.Substring(3, 1) = "R" Then
            lstColors.Items.Add(itemNum & ": Red")
        ElseIf itemNum.ToUpper.Substring(3, 1) = "W" Then
    ...
    Private Sub DisplayDelivery(ByVal partNum As String)
        ...
        If partNum.Length <> 3 AndAlso partNum.Length <> 4 Then
            MessageBox.Show("Invalid Part Number: " & partNum, "Invalid input", MessageBoxButtons.OK)
        End If

        If partNum.ToUpper Like "##MS" Then
            lstDelivery.Items.Add("Mail - Standard")
        ElseIf partNum.ToUpper Like "##MP" Then
            lstDelivery.Items.Add("Mail - Priority")
        ElseIf partNum.ToUpper Like "##FS" Then
            lstDelivery.Items.Add("FedEx - Standard")
        ElseIf partNum.ToUpper Like "##FO" Then
            lstDelivery.Items.Add("FedEx - Overnight")
        ElseIf partNum.ToUpper Like "##U" Then
            lstDelivery.Items.Add("UPS")
        Else lstDelivery.Items.Add("Invalid: " & partNum)
        End If
    ...
    Private Sub btnProper_Click(sender As Object, e As EventArgs) Handles btnProper.Click
        ...
        strName = strName.Insert(0, strFirstChar.ToUpper)

        If strName.Contains(" ") Then
            intLastChar = strName.IndexOf(" ")
            strLastChar = strName.Substring(intLastChar + 1, 1)
            strName = strName.Remove(intLastChar + 1, 1)
            strName = strName.Insert(intLastChar + 1, strLastChar.ToUpper)
        End If
